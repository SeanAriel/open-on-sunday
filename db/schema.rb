...
ActiveRecord::Schema.define(version: 20160819100549) do
  ...
  create_table "forumoffers", force: :cascade do |t|
    t.integer  "user_id"
    t.text     "content"
    t.integer  "offer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["offer_id"], name: "index_forumoffers_on_offer_id", using: :btree
    t.index ["user_id"], name: "index_forumoffers_on_user_id", using: :btree
  end
  ...
  create_table "messtousers", force: :cascade do |t|
    t.string   "title"
    t.text     "content"
    t.integer  "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_messtousers_on_user_id", using: :btree
  end
  ...
  add_foreign_key "forumoffers", "offers"
  add_foreign_key "forumoffers", "users"
  add_foreign_key "meetings", "availabilities"
  add_foreign_key "meetings", "offers"
  add_foreign_key "meetings", "users"
  add_foreign_key "messtousers", "users"
